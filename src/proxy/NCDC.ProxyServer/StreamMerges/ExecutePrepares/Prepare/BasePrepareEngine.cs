...
using OpenConnector.RewriteEngine;
using OpenConnector.RewriteEngine.Context;
using OpenConnector.RewriteEngine.Engine;
using OpenConnector.Route;
using OpenConnector.Route.Context;
using OpenConnector.ShardingAdoNet;
using OpenConnector.Spi.Order;

namespace NCDC.ProxyServer.StreamMerges.ExecutePrepares.Prepare
{
    /*
    * @Author: xjm
    * @Description:
    ...
    */
    public abstract class BasePrepareEngine
    {
        ...
        protected BasePrepareEngine(ICollection<IBaseRule> rules, ConfigurationProperties properties, OpenConnectorMetaData metaData, ISqlCommandParser sqlCommandParser)
        {
