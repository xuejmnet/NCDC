...
public class EffectRowServerResult:IServerResult
{
    ...
    public EffectRowServerResult():this(new List<EffectRowUnitResult>(0))
    {
        
    }

    public EffectRowServerResult(List<EffectRowUnitResult> updateResults)
    {
