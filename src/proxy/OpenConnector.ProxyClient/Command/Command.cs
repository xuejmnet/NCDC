...
{
    private static readonly ILogger<Command> _logger = InternalLoggerFactory.CreateLogger<Command>();
    ...
    public Command(IDatabaseProtocolClientEngine databaseProtocolClientEngine,
