...
namespace ShardingConnector.ParserBinder.Segment.Select.Projection
{
/*
* @Author: xjm
* @Description:
...
*/
    public sealed class ProjectionsContext
    {
       ...
       /// </summary>
       /// <returns></returns>
        public List<ParserBinder.Segment.Select.Projection.IProjection> GetExpandProjections()
        {
            List<ParserBinder.Segment.Select.Projection.IProjection> result = new List<ParserBinder.Segment.Select.Projection.IProjection>();
            foreach (var projection in _projections)
            {
