...
using ShardingConnector.CommandParser.SqlParseEngines.Core.Parser;
...
namespace ShardingConnector.CommandParser.SqlParseEngines
{
    /*
    * @Author: xjm
    * @Description:
    ...
    */
    public class SqlParserEngine
    {
        ...
        public SqlParserEngine(ISqlParserConfiguration sqlParserConfiguration)
        {
