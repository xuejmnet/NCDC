...
using OpenConnector.Sharding.Configurations.ShardingTableConfigurations;

namespace OpenConnector.Sharding.Configurations;
...
public sealed class ShardingConfiguration
{
    ...
    public void AddExtraDataSource(string dataSourceName, string connectionString)
    {
        ...
        {
            throw new ShardingException("extra data source repeat");
        }
    }
