...
//         }
//
//         public List<IStreamDataReader> ExecuteDbDataReader(bool serial, StreamMergeContext streamMergeContext,
//             CancellationToken cancellationToken = new CancellationToken())
//         {
//             var executor = new AdoNetShardingExecutor<IStreamDataReader>();
//             executor.OnCommandSqlExecute += GetQueryEnumerator;
//             
//             return ShardingExecute<IStreamDataReader>(executor,serial, streamMergeContext, cancellationToken);
//         }
//
//         public List<int> ExecuteNonQuery(bool serial,StreamMergeContext streamMergeContext, CancellationToken cancellationToken = new CancellationToken())
//         {
//             var executor = new AdoNetShardingExecutor<int>();
//             executor.OnCommandSqlExecute += DoExecuteNonQuery;
//             return ShardingExecute<int>(executor,serial, streamMergeContext, cancellationToken);
//         }
//
//         private List<TResult> ShardingExecute<TResult>(IExecutor<TResult> executor,bool serial, StreamMergeContext streamMergeContext,
//             CancellationToken cancellationToken = new CancellationToken())
//         {
//             var waitSqlExecuteResults = streamMergeContext.GetExecutionUnits().GroupBy(o => o.GetDataSourceName())
