...
using OpenConnector.ShardingRoute.Engine.Condition.Engine;
using OpenConnector.ShardingRoute.Engine.RouteType;
using OpenConnector.ShardingRoute.Engine.Validator;
using OpenConnector.Spi;

namespace OpenConnector.ShardingRoute.Engine
{
    /*
    * @Author: xjm
    * @Description:
    ...
    */
    public class ShardingRouteDecorator: IRouteDecorator<ShardingRule>
    {
        ...
        public RouteContext Decorate(RouteContext routeContext, OpenConnectorMetaData metaData, IBaseRule rule,
            ConfigurationProperties properties)
        {
