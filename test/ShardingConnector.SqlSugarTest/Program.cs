...
namespace ShardingConnector.SqlSugarTest
{
    /// <summary>
    /// 还未实现
    /// </summary>
    internal class Program
    {
        ...
        { //创建数据库对象
            ...
            db.Ado.Connection = dbConnection;
            var ids = new[]{"21","22"};
            var users = db.Queryable<User>().Where(o=>ids.Contains(o.Id)).ToList();
        }
