...
//
// namespace ShardingConnector.HiSqlTest
// {
...
//                 {
//                     "ds0",
//                     new GenericDataSource(MySqlClientFactory.Instance,conn,true)
//                 }
//             };
//             //2、分库分表配置
...
//                 var users = dbConnection.Query<User>("select * from  SysUserMod where id  in @ids",new{ids=new[]{"21","22"}}).ToList();
//                 
//             }
//         }
//
